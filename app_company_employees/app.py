...
from company_employees.models import db
from flask_jwt_extended import JWTManager
from flask_openapi3 import Info
from flask_openapi3 import OpenAPI

ACTIVATE_ENDPOINTS = (('/', company_employees),)

info = Info(title="Company Employees API", version="1.12.2")

app = OpenAPI(__name__,
              info=info,
              doc_prefix="/company-employees/docs"
              )
...
dbname = os.getenv('DB_NAME', 'company_employees_db')
